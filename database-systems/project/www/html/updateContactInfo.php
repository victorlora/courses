<?php
	...
	$contactId = $_POST["contactId"] ? $_POST["contactId"] : NULL;
	$uname = $_POST["userName"] ? $_POST["userName"] : NULL;
...
<head>
	...
	<script>
		function successAlert() {
			...
			window.location.href="contactInfo.php?contactId=<?php echo $contactId ?>";
		}
