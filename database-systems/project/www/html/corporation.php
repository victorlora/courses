...
<?php
	...
	$query = "SELECT c.objectid 'ID', name 'Corporation', "
			." Street, City, State, zip_code 'Zip Code', Country "
			."FROM Corporation c "
	...
	// Create the table
	print "<table class='table'><h1>Corporations<button type=\"button\" class=\"btn btn-default pull-right\" aria-label=\"Right Align\" 
			onclick=\"window.location.href='addCorporation.html'\">
	...
	for ($i = 0; $i < $num_rows; $i++) {
		...
		print 	"<th><button type=\"button\" class=\"btn btn-default\" aria-label=\"Right Align\" 
					onclick=\"window.location.href='removeCorporation.php?corporationId=" .$row[0]."'\">
