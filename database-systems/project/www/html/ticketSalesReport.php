...
<?php
	...
	$query = "SELECT c.fname 'First Name', c.lname 'Last Name', p.title 'Title', t.name 'Theater'"
			."FROM Admission_Ticket a "
			."INNER JOIN Play p "
			."ON p.objectid = a.play_id "
			."INNER JOIN Theater t "
			."ON t.objectid = a.theater_id "
			."INNER JOIN Contact c "
			."ON c.objectid = a.contact_id";
	trim($query);
	...
	print "<table class='table'><h1>Tickets Purchased</h1>";
	print "<tr>";
