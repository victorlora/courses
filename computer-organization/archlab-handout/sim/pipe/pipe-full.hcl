...
# PC update     PC <- valP
#
# Note: For leave we put it wherever we saw a popl in the pipeline
# register control figuring it followed the same logic in taking
# care of hazards.
#
#
#/* $begin pipe-all-hcl */
