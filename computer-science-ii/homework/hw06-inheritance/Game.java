...
public class Game extends ItemList{
    ...
    public static final int ACTION_COUNT_MAX    = 60;
    public static final int PLACE_COUNT_MAX     = 60;
     ...
     * @param       Stringlabel         must not be null or blank
    ...
    {
        if (null == newPlayer) { return false; }
        // FUTURE: auto-expand actionList when full, prevent duplicates
    ...
    public void play()
    {
        ...
        while (null != place) {
            ...
            if (text.equalsIgnoreCase("quit")) {
                ...
                Item   item       = player.getItem(userChoice);
                player.removeItem(userChoice);
                place.addItem(item);
                if (null != item) {
                ...
                String userChoice = scanner.nextLine();
                Item   item       = place.getItem(userChoice);
                place.removeItem(userChoice);
                player.addItem(item);
                if (null != item) {
    ...
    { 
        ...
        Item    razor        = new Item("razor","A rusty razorblade");
