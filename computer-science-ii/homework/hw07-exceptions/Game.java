...
public class Game extends ItemList{
    ...
    public void addAction(Action newAction)
    {
        ...
        if (this.actionList.length == actionCount) { 
            throw new IllegalArgumentException("Action array list is full");
        }
    ...
    public void addPlace(Place newPlace)
    {
        ...
        if (this.placeList.length == placeCount) { 
            throw new IllegalArgumentException("Place array list is full");
        }
